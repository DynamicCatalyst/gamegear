...
public class SecurityConfig {
    // Injected as an instance field rather than static: @Value can't populate a
    // static field, and the secured-URL list needs the resolved api.prefix.
    @Value("${api.prefix}")
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, CorsConfigurationSource corsConfigurationSource) throws Exception {
        ...
        List<String> securedUrls =
                List.of(apiPrefix + "/carts/**", apiPrefix + "/cartItems/**", apiPrefix + "/orders/**");
