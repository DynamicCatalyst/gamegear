...
public class ProductController {
    ...
    /**
     * Server-side paginated + filtered catalog search.
     * Example: /products/search?page=0&size=12&category=Consoles&brand=Sony&name=ps
     */
    @GetMapping("/search")
    public ResponseEntity<ApiResponse> searchProducts(
        ...
        return ResponseEntity.ok(new ApiResponse("success",
                productService.searchProducts(category, brand, name, page, size)));
    }
